...
test('Testing attributeChangedCallback function to correctly alter task display', () => {
    ...
    // const mockCallBack = jest.fn(o_task_disp.attributeChangedCallback);
    // o_task_disp.attributeChangedCallback = jest.fn();
    // const mockCallback = jest.spyOn(o_task_disp, "attributeChangedCallback");
    // expect(o_task_disp.attributeChangedCallback.mock.calls).toBe("numtasks");
    // o_task_disp.attributeChangedCallback("numtasks", 0, 1);

    const mockCallback = jest.spyOn(o_task_disp, "wrapperAttributeFunction");
    ...
    expect(mockCallback.mock.calls[0][0]).toBe("numtasks");
    ...
    expect(mockCallback.mock.calls[1][2]).toBe("1");
    ...
    expect(mockCallback.mock.calls[2][0]).toBe("numtasks");
    // The third arg of the third call to attributeChangedCallback to be 0
    expect(mockCallback.mock.calls[2][2]).toBe("2");
    ...
    expect(mockCallback.mock.calls[3][0]).toBe("currtask");
    ...
    expect(mockCallback.mock.calls[4][0]).toBe("nexttask");
    // The third arg of the fifth call to attributeChangedCallback to be "Do Homework"
    expect(mockCallback.mock.calls[4][2]).toBe("Do Homework");
